...
--------------------------------------------------------
  ...
  CREATE TABLE "INGDATA"."TRANSACCION" 
...
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('2',to_date('15/11/23','DD/MM/RR'),'Vacunación','33445566','2','1');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('3',to_date('15/11/23','DD/MM/RR'),'Revisión dental','44556677','3','2');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('4',to_date('15/11/23','DD/MM/RR'),'Desparasitación','55667788','4','2');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('5',to_date('15/11/23','DD/MM/RR'),'Cirugía','66778899','8','3');
...
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('7',to_date('15/11/23','DD/MM/RR'),'Esterilización','88990011','7','1');
...
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('9',to_date('15/11/23','DD/MM/RR'),'Consulta dermatológica','10112233','5','3');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('10',to_date('15/11/23','DD/MM/RR'),'Radiografía','12131415','6','2');
...
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('12',to_date('15/11/23','DD/MM/RR'),'Vacunación','14151617','2','1');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('13',to_date('15/11/23','DD/MM/RR'),'Revisión dental','15161718','3','2');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('14',to_date('15/11/23','DD/MM/RR'),'Desparasitación','16171819','4','2');
Insert into INGDATA.CITA (ID_CITA,FECHAREGISTRO,RAZONCITA,ID_CLIENTE,ID_MASCOTA,ID_VETERINARIO) values ('15',to_date('15/11/23','DD/MM/RR'),'Cirugía','17181920','8','3');
...
SET DEFINE OFF;
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('1',to_date('14/02/20','DD/MM/RR'),'Fiebre y malestar general','Antibióticos y reposo','71234567','11');
...
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('4',to_date('05/03/23','DD/MM/RR'),'Infección en el oído','Gotas para los oídos y antibióticos','84567890','14');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('5',to_date('20/05/20','DD/MM/RR'),'Problemas dentales','Extracción de dientes y cuidado dental','95678901','15');
...
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('7',to_date('28/02/22','DD/MM/RR'),'Problemas respiratorios','Antibióticos y cuidado en casa','67890123','17');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('8',to_date('08/06/23','DD/MM/RR'),'Alergias cutáneas','Medicamentos antialérgicos y baños especiales','78901234','18');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('9',to_date('15/11/20','DD/MM/RR'),'Problemas oculares','Gotas para los ojos y revisión periódica','89012345','19');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('10',to_date('30/01/21','DD/MM/RR'),'Fractura en una pata','Inmovilización y cirugía','11223344','20');
...
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('13',to_date('18/02/20','DD/MM/RR'),'Infección en el oído','Gotas para los oídos y antibióticos','44556677','23');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('14',to_date('03/04/21','DD/MM/RR'),'Problemas dentales','Extracción de dientes y cuidado dental','55667788','24');
...
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('16',to_date('05/01/23','DD/MM/RR'),'Problemas respiratorios','Antibióticos y cuidado en casa','77889900','26');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('17',to_date('23/09/20','DD/MM/RR'),'Alergias cutáneas','Medicamentos antialérgicos y baños especiales','88990011','27');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('18',to_date('08/11/21','DD/MM/RR'),'Problemas oculares','Gotas para los ojos y revisión periódica','99001122','28');
Insert into INGDATA.HISTORIACLINICA (ID_HISTORIA,FECHAREGISTRO,DIAGNOSTICO,TRATAMIENTO,DNI_CLIENTE,ID_MASCOTA) values ('19',to_date('19/02/22','DD/MM/RR'),'Fractura en una pata','Inmovilización y cirugía','10112233','29');
...
Insert into INGDATA.INSTRUMENTOMEDICO (ID_INSTRUMENTO,NOMBRE,DESCRIPCION,PRECIOCOMPRA,ID_PROVEEDOR) values ('2','Term?metro','Un instrumento que mide la temperatura corporal de los animales','20','6');
...
REM INSERTING into INGDATA.TRANSACCION
SET DEFINE OFF;
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('1',to_timestamp('28/03/23 01:45:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','75','93456789',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('2',to_timestamp('03/05/23 02:00:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','150',null,'7');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('3',to_timestamp('26/04/23 04:30:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','40','95678901',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('4',to_timestamp('12/05/23 01:00:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','180',null,'4');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('5',to_timestamp('20/02/23 11:15:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','90','67890123',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('6',to_timestamp('09/05/23 02:30:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','120',null,'9');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('7',to_timestamp('05/04/23 04:00:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','60','11223344',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('8',to_timestamp('18/04/23 01:45:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','190',null,'2');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('9',to_timestamp('17/01/23 02:30:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','100','22334455',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('10',to_timestamp('07/02/23 12:15:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','160',null,'6');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('11',to_timestamp('14/05/23 09:45:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','80','33445566',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('12',to_timestamp('17/04/23 12:00:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','170',null,'8');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('13',to_timestamp('13/04/23 11:15:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','50','44556677',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('14',to_timestamp('04/04/23 04:45:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','140',null,'3');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('15',to_timestamp('19/05/23 03:00:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','110','55667788',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('16',to_timestamp('04/06/23 05:15:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','130',null,'5');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('17',to_timestamp('14/02/23 10:30:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','70','66778899',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('18',to_timestamp('26/06/23 04:15:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','200',null,'1');
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('19',to_timestamp('31/05/23 01:30:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Venta','55','17181920',null);
Insert into INGDATA.TRANSACCION (ID_TRANSACCION,MOMENTODIA,TIPO,MONTO,ID_CLIENTE,ID_PROVEEDOR) values ('20',to_timestamp('29/06/23 10:45:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'Compra','100',null,'10');
REM INSERTING into INGDATA.VETERINARIO
SET DEFINE OFF;
Insert into INGDATA.VETERINARIO (DNI_VETERINARIO,NOMBRES,APELLIDOS,TELEFONO,DIRECCION,CORREO,ESPECIALIDAD) values ('1','Pedro','García','3456789','Calle 123','correo1@gmail.com','Cirugía');
Insert into INGDATA.VETERINARIO (DNI_VETERINARIO,NOMBRES,APELLIDOS,TELEFONO,DIRECCION,CORREO,ESPECIALIDAD) values ('2','Laura','Martínez','2345678','Calle 456','correo2@gmail.com','Dermatología');
Insert into INGDATA.VETERINARIO (DNI_VETERINARIO,NOMBRES,APELLIDOS,TELEFONO,DIRECCION,CORREO,ESPECIALIDAD) values ('3','Carlos','Rodríguez','12345678','Calle 789','correo3@gmail.com','Oftalmología');
--------------------------------------------------------
...
BEGIN
   FOR rec_especie IN (SELECT DISTINCT Especie FROM Mascota) LOOP
       ...
       BEGIN
           ...
           -- Puedes agregar más detalles o formateo según sea necesario
       END;
   END LOOP;
...
--------------------------------------------------------
  ...
  ALTER TABLE "INGDATA"."TRANSACCION" ADD PRIMARY KEY ("ID_TRANSACCION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TSI_USERDB"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "INGDATA"."TRANSACCION" ADD CONSTRAINT "FK_CLIENTETRANSACCION" FOREIGN KEY ("ID_CLIENTE")
	  REFERENCES "INGDATA"."CLIENTE" ("DNI_CLIENTE") ENABLE;
  ALTER TABLE "INGDATA"."TRANSACCION" ADD CONSTRAINT "FK_PROVEEDORTRANSACCION" FOREIGN KEY ("ID_PROVEEDOR")
	  REFERENCES "INGDATA"."PROVEEDOR" ("ID_PROVEEDOR") ENABLE;
