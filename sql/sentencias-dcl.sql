...
CREATE USER VETERINARIO IDENTIFIED BY 2023; GRANT ALL PRIVILEGES TO INGDATA;
CREATE USER RECEPCIONISTA IDENTIFIED BY 2023; GRANT ALL PRIVILEGES TO INGDATA;
